...
<html>
    ...
    <body id="LoginForm">
        ...
        <div >
          ...
          <h1 class="form-heading"><img src="imgs/logo.png" width=400px height=110px alignment="left"><br> Voting System</h1>
          <br>
             ...
             <p>Please enter your ID and Password</p>
              ...
              <form id="Login" action="loginservlet" method="post">
                  ...
                  <div class="form-group">
                      ...
                      <input name="uid" type="number" class="form-control" id="uid" placeholder="Enter ID" onKeyUp="limitText(this,10);" />
