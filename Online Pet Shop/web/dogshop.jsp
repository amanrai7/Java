...
"imgs/chitu.jpg" 
    ...
    <div class="#4fc3f7 light-blue lighten-2 nav-content">
      <ul class="tabs tabs-transparent z-depth-3">
          ...
          <li class="tab"><a class="large active" href="dogshop.jsp">Shop A Dog</a></li>
...
<!--            <br>
    ...
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator" src="imgs/shusky.jpg">
    </div>
    <div class="card-action">
      <span class="card-title activator grey-text text-darken-4">Siberian Husky<i class="material-icons right">more_vert</i></span>
      <br><span class="card-title activator grey-text text-darken-4">&#8377 42000</span>
      <br>
      <br>
      <a class="modal-trigger btn" href="#shusky">Buy Now</a>

          <div class="row">
          <div id="shusky" class="white black-text modal">
      ...
      <div class="row">
        ...
        <div class="input-field col s8">
          ...
          <div class="row">
        <div class="input-field col s8">
            <input name="uanimal" id="addrs" type="text" value="Siberain Husky" class="validate" readonly>
          <label for="animal">Pet Selected</label>
        </div>
      </div>
          <div class="row">
        <div class="input-field col s8">
            <input name="uprice" id="price" type="text" class="validate" value="42000" readonly>
    ...
    <div class="#00e5ff cyan accent-3 black-text card-reveal">
      <span class="card-title black-text text-darken-4">Siberian Husky<i class="material-icons right">close</i></span>
      <p>The Siberian Husky is a beautiful dog breed with a thick coat that comes in a multitude of colors and markings. Their blue or multi-colored eyes and striking facial masks only add to the appeal of this breed, which originated in Siberia. It is easy to see why many are drawn to the Siberian?s wolf-like looks, but be aware that this athletic, intelligent dog can be independent and challenging for first-time dog owners. Huskies also put the ?H? in Houdini and need a fenced yard that is sunk in the ground to prevent escapes.</p>
          ...
          <div class="col s3 offset-s1">
                                ...
                                <div class="large card z-depth-3">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator" src="imgs/gshep.jpg">
    </div>
    <div class="card-action">
      <span class="card-title activator grey-text text-darken-4">German Shepherd<i class="material-icons right">more_vert</i></span>
      <br><span class="card-title activator grey-text text-darken-4">&#8377 15000</span>
      <br>
      <br>
      <a class="modal-trigger btn" href="#gsp">Buy Now</a>

          <div class="row">
          <div id="gsp" class="white black-text modal">
            <div class="modal-content">
                <form action="order1" method="post">
      ...
      <div class="row">
        ...
        <div class="input-field col s8">
          ...
          <div class="row">
        <div class="input-field col s8">
            <input name="uanimal" id="addrs" type="text" value="German Shepherd" class="validate" readonly>
          <label for="animal">Pet Selected</label>
        </div>
      </div>
          <div class="row">
    ...
    <div class="#00e5ff cyan accent-3 black-text card-reveal">
      <span class="card-title black-text text-darken-4">German Shepherd<i class="material-icons right">close</i></span>
      <p>The German Shepherd Dog is a natural protector and so adaptable and intelligent that he has performed just about every job known to dog. If he had opposable thumbs, he would be unstoppable.</p>
    </div>
  </div>
