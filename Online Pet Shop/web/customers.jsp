...
<%
         ...
         String query1="select * from bande where email!=?";
...
<html>
    ...
    <div class="#4fc3f7 light-blue lighten-2 nav-content">
      <ul class="tabs tabs-transparent z-depth-3">
          <li class="tab"><a class="large " href="admin.jsp">Home</a></li>
          <li class="tab"><a class="large active" href="customers.jsp">Customers</a></li>
