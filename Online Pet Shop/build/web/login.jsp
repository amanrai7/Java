    ...
    $('.sidenav').sidenav();
        ...
        <form action="loginserv" method="post">
            ...
            <div class="input-field col s6">
              <input id="first_name2" type="text" class="validate" name="umail">
              <label class="active" for="first_name2">Email</label>
            </div>
                </div>
            <div class="row">
            <div class="input-field col s6">
              <input id="first_name2" type="password" class="validate" name="upass">
            ...
            <div class="row">
            <div class="input-field col s6">
              <input type="submit" class="#e3f2fd blue lighten-5 black-text waves-effect waves-dark btn" value="Login">
            </div>
                </div>
